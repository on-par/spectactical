...
- Launch Claude Code in the review environment

## Purpose

Local review enables:
- **Safe Testing**: Review colleague's work without affecting main workspace
- **Complete Setup**: Full development environment with proper dependencies
- **Isolated Changes**: Test branches in isolation with proper configuration
- **Efficient Review**: Quick setup for thorough code review

## Workflow Integration

Typically used for:
- Code review before merging
- Testing complex changes locally
- Collaborative debugging sessions
- Feature validation and testing

The local review environment provides a complete, isolated setup for thorough evaluation of changes.